...
| 5 — Security, Proctoring & Analytics | Integrity detection, event logging, freeze/resume/terminate, control room, analytics, audit trail | `backend/app/security`, `backend/app/analytics`, `frontend/src/examiner` |
